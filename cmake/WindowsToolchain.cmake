...
set(CMAKE_C_FLAGS_DEBUG "/Od ${WIN_DEBUG_INFORMATION_FORMAT} ${WIN_EXCEPTION_HANDLING_MODEL} ${WIN_USE_RUNTIME_LIBRARY_DEBUG} ${WIN_PREPROCESSOR_POCO_STATIC} ${WIN_PREPROCESSOR_EASYHTTPCPP_DLL}" CACHE STRING "C compile flags debug" FORCE)
set(CMAKE_C_FLAGS_RELEASE "/O2 /DNDEBUG ${WIN_EXCEPTION_HANDLING_MODEL} ${WIN_USE_RUNTIME_LIBRARY_RELEASE} ${WIN_PREPROCESSOR_POCO_STATIC} ${WIN_PREPROCESSOR_EASYHTTPCPP_DLL}" CACHE STRING "C compile flags release" FORCE)
set(CMAKE_C_FLAGS_MINSIZEREL "/Os /DNDEBUG ${WIN_EXCEPTION_HANDLING_MODEL} ${WIN_USE_RUNTIME_LIBRARY_RELEASE} ${WIN_PREPROCESSOR_POCO_STATIC} ${WIN_PREPROCESSOR_EASYHTTPCPP_DLL}" CACHE STRING "C compile flags minsizerel" FORCE)
set(CMAKE_C_FLAGS_RELWITHDEBINFO "/O2 /DNDEBUG ${WIN_DEBUG_INFORMATION_FORMAT} ${WIN_EXCEPTION_HANDLING_MODEL} ${WIN_USE_RUNTIME_LIBRARY_RELEASE} ${WIN_PREPROCESSOR_POCO_STATIC} ${WIN_PREPROCESSOR_EASYHTTPCPP_DLL}" CACHE STRING "C compile flags relwithdebinfo" FORCE)
set(CMAKE_CXX_FLAGS_DEBUG "/Od ${WIN_DEBUG_INFORMATION_FORMAT} ${WIN_EXCEPTION_HANDLING_MODEL} ${WIN_USE_RUNTIME_LIBRARY_DEBUG} ${WIN_CXX_SECURE_OVERLOAD_OPTIONS} ${WIN_PREPROCESSOR_POCO_STATIC} ${WIN_PREPROCESSOR_EASYHTTPCPP_DLL}" CACHE STRING "CXX compile flags debug" FORCE)
set(CMAKE_CXX_FLAGS_RELEASE "/O2 /DNDEBUG ${WIN_EXCEPTION_HANDLING_MODEL} ${WIN_USE_RUNTIME_LIBRARY_RELEASE} ${WIN_CXX_SECURE_OVERLOAD_OPTIONS} ${WIN_PREPROCESSOR_POCO_STATIC} ${WIN_PREPROCESSOR_EASYHTTPCPP_DLL}" CACHE STRING "CXX compile flags release" FORCE)
set(CMAKE_CXX_FLAGS_MINSIZEREL "/Os /DNDEBUG ${WIN_EXCEPTION_HANDLING_MODEL} ${WIN_USE_RUNTIME_LIBRARY_RELEASE} ${WIN_CXX_SECURE_OVERLOAD_OPTIONS} ${WIN_PREPROCESSOR_POCO_STATIC} ${WIN_PREPROCESSOR_EASYHTTPCPP_DLL}" CACHE STRING "CXX compile flags minsizerel" FORCE)
set(CMAKE_CXX_FLAGS_RELWITHDEBINFO "/O2 /DNDEBUG ${WIN_DEBUG_INFORMATION_FORMAT} ${WIN_EXCEPTION_HANDLING_MODEL} ${WIN_USE_RUNTIME_LIBRARY_RELEASE} ${WIN_CXX_SECURE_OVERLOAD_OPTIONS} ${WIN_PREPROCESSOR_POCO_STATIC} ${WIN_PREPROCESSOR_EASYHTTPCPP_DLL}" CACHE STRING "CXX compile flags relwithdebinfo" FORCE)
